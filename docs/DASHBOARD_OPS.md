...
| **风控与模式** | [Preview · Live · Kill Switch](dashboard/06-risk-and-modes.md) |
| **系统设置** | [设置页各标签说明](dashboard/07-settings.md) |
| **常见问题** | [FAQ](dashboard/08-faq.md) |

在 Dashboard 内打开 **操作文档** 页可浏览完整内容（含速查表与完整说明书）。

## 推荐阅读顺序

```
安装登录 → 配置钱包 → 添加 Leader → Preview 观察 → 调整策略 → 开 Live
```

详见 [01-overview.md](dashboard/01-overview.md) 中的推荐使用流程。
